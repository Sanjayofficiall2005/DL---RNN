...
def train_model(model,train_loader,criterion,optimizer,epochs=20):
  ...
  for epoch in range(epochs):
    ...
    train_loses.append(total_loss/len(train_loader))
...
<img width="769" height="703" alt="image" src="https://github.com/user-attachments/assets/fa17908a-0c0b-4646-8b35-41b87289e58c" />



## True Stock Price, Predicted Stock Price vs time And Predictions
<img width="868" height="529" alt="image" src="https://github.com/user-attachments/assets/4d8a029c-88d6-4c58-b9a1-9afb0433a1e3" />
